...
#     skw301 = Skw101.objects.get(id = id)
#     skw301.delete()
#     return redirect('/skw301')

# # skw302  
# class MainViewSkw302(FormView):
#     template_name = 'layouts/zone_n.html'
#     form_class = Skw302Form
#     def get_context_data(self, **kwargs):
...
#             # print(d)
#             form = Skw102Form(instance = skw102)
...
#             # print(d)
#             form = Skw103Form(instance = skw103)
...
#     skw1003 = Skw103.objects.get(id = id)
#     skw1003.delete()
#     return redirect('/skw103')   